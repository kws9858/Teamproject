		          ...
		          <div class="col-md-12">
		          	<div class="row mb-4">
						<div class="col-md-12 d-flex justify-content-between align-items-center">
							...
							<a href="#">
		                        <button class="btn btn-primary" style="width: 100px; height: 30;">찾아보기</button>
							</a>	
							<a href="#">
		                        <button class="btn btn-primary" style="width: 150px; height: 30;">내 동네 보기</button>
							</a>
		               		<a href="<c:url value='/CreatePerformance.do'/>">
		                        <button class="btn btn-primary" style="width: 150px; height: 30;">공연 만들기</button>
							</a>
						</div>
					</div>
		          </div>
