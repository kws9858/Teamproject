		...
		return function() {
			$.ajax({
				...
				console.log(data[0].meetingName);
					...
					var div="<div>";
					div +="<img src='<c:url value='images/"+data[0].operator+"/"+data[0].meetingName+"/Performance/"+data[0].main_img+"'/>' alt='Raised circle image' style='width: 200px; height: 200px; margin-left: 8%; margin-top:5%'>";
