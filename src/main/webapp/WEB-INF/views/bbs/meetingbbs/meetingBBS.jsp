   ...
   <div class="container" style="margin-top: 50px;">
      <div class="row justify-content-center">
         <div class="col-md-10" style="text-align: right;">
            <a href="<c:url value='/WriteMeetingBBS.do'/>">
               우리 모임의 활동을 공유해보세요!
               <button class="btn"style="width: 100px; height: 50; background-color: #FF7A5C; color: white;">작성하기</button>
            </a>
         </div>
      </div>
   </div>
                  ...
                  <div class="item wrapper" style="display: inline-block; width: 720px;">
                     <div class="testimony-wrap py-5" style="margin-bottom: 50px; width: 710px;">
                        ...
                        <div class="row" style="margin-bottom: 10px; height: 50px; margin-right: 0px; margin-left: 0px; padding-left: 0px; padding-right: 0px;">
                           <img class="icon d-flex align-items-center" style=" width: 50px; height: 50px; border-radius: 50%; border: 2px solid black;"  src="<c:url value="/images/${mBBSList['BANNERIMG']}"/>"></img>
                           ...
                           <div class="carousel-inner" style="height: 500px;">
                              ...
                              <c:forEach items="${mBBSList['mBBSImg']}" var="mBBSImg" varStatus="statusimglist" >
                                    <div class="carousel-item <c:if test="${statusimglist.count== 1 }">active</c:if>">
                                       <img class="d-block w-100" src="<c:url value="/images/bbs/bbsno${mBBSList['BBSNO'] }/${mBBSImg}"/>" style="max-width: 100%; height: 500px;">
                                    </div>
                              </c:forEach>
                           </div>
                           <c:if test="${mBBSList['imgcount'] != '1' }">
                        ...
                        <div class="text" style="margin-top: 20px;">
                           <div class="commentinput" style="align-items: center">
                              ...
                              <c:if test="${not notNull}">
                                 <img class="icon d-flex align-items-center" style="width: 50px; height: 50px; border-radius: 50%; background-color:#FFB8A8;"  src="<c:url value="/images/${dto.id}/${dto.profileimg}"/>"></img>
                              </c:if>
