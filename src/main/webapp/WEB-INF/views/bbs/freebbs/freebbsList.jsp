...
<!-- END nav -->
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate mb-0 text-center">
            ...
            <h1 class="mb-0 bread" style="color: white;">자유롭게 떠들어보시게들</h1>
          </div>
        </div>
      </div>
    </section>
            ...
            <div class="row justify-content-center">
               <div class="col-md-12">
                        ...
                        <div class="item">
                          ...
                          <div class="carousel-inner" style="width: 785px; height: 500px;">
                             ...
                             <div class="text" style="margin-top: 20px;">
                                       <div class="commentinput" style="align-items: center">
                                          <div class="input-group align-items-center">
                                                ...
                                                <input type="text" class="form-control" style="height:60px;  width: 600px; margin-left: 10px; padding-top: 10px; color: gray;" placeholder="댓글을 입력하세요" onfocus="this.placeholder=''" onblur="this.placeholder='댓글을 입력하세요'">
    ...
    <section class="ftco-section">
         <div class="container" style="margin-top: 100px;">
            <div class="row justify-content-center">
               <div class="col-md-12" style="margin-top: 100px; margin-bottom: 100px; text-align: center;">
