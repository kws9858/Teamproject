									...
									<div class="row">
										...
										<div class="col-md-10">
											<div class="form-group">
												...
												<input type="password" class="form-control" name="passwordCheck" id="passwordCheck" maxlength="15">
										...
										<div class="col-md-10" style="display: block;">
											<div class="form-group">
												...
												<input type="tel" class="form-control" name="tel" id="tel" placeholder="-빼고 숫자만 입력해주세요" maxlength="11"/>
