	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="ftco-nav">
			<ul class="navbar-nav m-auto">
				<li class="nav-item dropdown" id="update" style="position: relative;"><a href="#" class="nav-link">개인정보수정</a>
					<ul class="dropdown-menu" 
						style="list-style: none; font-size: 0.8em; position: absolute; " id="subMenu">
				...
				<li class="nav-item" id="bookMark"><a id="Myquestion" href="<c:url value='MyQuestion.do'/>" class="nav-link">내 문의함</a></li>
			</ul>    
		</div>
	</div>
</nav>
