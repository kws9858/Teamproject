											    	...
											    	<div class="container">
												      <div class="row">
												      	...
												      	<div class="offset-8 col-2">
												      		...
												      		<button class="btn btn-success" id="disabled${item.BAccusationNo}" <c:if test="${item.process != '접수'}">disabled="disabled"</c:if> onclick="javascript:openmodal(${item.bbsNo},${item.BAccusationNo},${item.id})">조치하기</button>
												      	</div>
												      </div>
											      </div>    
											    </td>
...
<script>
	...
	function openmodal(bbsno,baccusationno,id) {
		$.ajax({
