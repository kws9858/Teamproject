								...
								<div class="quotation-icon d-flex align-items-center justify-content-center">
								 ...
								 <div class="testimony-wrap box-size py-4">
									<div class="pull-left d-flex align-items-center justify-content-center" >
										<span><img class="pull-left" src="<c:url value='images/${pBBS["OPERATOR"]}/${pBBS["MEETINGNAME"]}/${pBBS["BANNERIMG"]}'/>" style="width:40px;height:40px;border-radius:50%;margin:-15px 10px 0px 10px;"/></span>
...
<script>
    ...
    /*──────────────────────────────────── 모임 추천 서비스 부분 ─────────────────────────────────────────────*/
    $.ajax({
    	url:'http://192.168.0.137:9090/recommends?low=1&high=5&user=${user_id}&count=3',
