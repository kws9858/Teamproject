	...
	<div class="container justify-content-center">
		<div class="col-lg-10" style="max-width: none; padding-left:3%;">
			<div class="row">
				...
				<a href='<c:url value="#"/>'><button class="btn btn-primary" style="width: 111%; height: 50;"> 모임 게시판</button></a>
				</div>
				<div class="col-md-2" role="group" style="padding: 0; margin-left: 2.3%;">
...
<!-- ======================작성하기 버튼=============================================
 ...
 ======================작성하기 버튼============================================= -->
    ...
    <!--=========================== 게시글 없을 때====================================== -->
<c:if test="${empty thisMeetingBBSList }">
    <section class="ftco-section">
...
<!-- =======================모임 게시판부분========================= -->
<section>
   <div class="container" style="margin-top: 10%; width: 710px;">
         ...
         <div class="row justify content-center" style="margin-right: 0px !important; padding-right: 0px !important; margin-left: 0px; padding-left: 0px; width: 710px; ">
               ...
               <!-- ============= 게시글 하나 ============== -->
               <c:forEach items="${thisMeetingBBSList}" varStatus="status" var="thisMeetingBBSList">
                  ...
                  <div class="item wrapper" style="display: inline-block; width: 720px;">
                     <div class="testimony-wrap py-5" style="margin-bottom: 50px; width: 710px;">
                        ...
                        <div class="row" style="margin-bottom: 10px; height: 50px; margin-right: 0px; margin-left: 0px; padding-left: 0px; padding-right: 0px;">
                           <img class="icon d-flex align-items-center" style=" width: 50px; height: 50px; border-radius: 50%; border: 2px solid black;"  src="<c:url value="/images/${thisMeetingBBSList['BANNERIMG']}"/>"></img>
                           <div class="col-md-10 col-md-offset-2" style="padding-top: 10px; font-size:20px; font-weight: bold; color: black;">${thisMeetingBBSList['MEETINGNAME'] }</div>
                              
                              
                          
                           <!-- <div class="col-md-4 col-md-offset-4"></div> -->
                           <!-- 드롭다운 -->
                           <c:if test="${thisMeetingBBSList['ID'] eq id  }">
                         <div class="col-md-1" style="padding-top: 10px;">
                       <div class="dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" >
                         <img alt="image" src="resources/images/menuIcon.png" style="height: 30px; width: 30px;">
                       </div>
                       <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                         <a class="dropdown-item" href="<c:url value="/EditMeetingBBS.do?BBSNO=${thisMeetingBBSList['BBSNO'] }"/>" style="text-align: center;">수정하기</a>
                         <a class="dropdown-item" href="<c:url value="/DeleteMeetingBBS.do?BBSNO=${thisMeetingBBSList['BBSNO'] }"/>" style="text-align: center;">삭제하기</a>
                       </div>
                    </div>
                  </c:if>
                        </div>
                        ...
                        <div id="carouselExampleIndicators${status.count }" class="carousel slide" data-ride="carousel"  data-interval="false">
                           <!-- 이미지 언더바 -->
                           <c:if test="${thisMeetingBBSList['imgcount'] != '1' }">
                           <ol class="carousel-indicators">
                              <c:forEach begin="1" end="${thisMeetingBBSList['imgcount'] }"  varStatus="statusimg">
                           ...
                           <div class="carousel-inner" style="height: 500px;">
                              ...
                              <c:forEach items="${thisMeetingBBSList['mBBSImg']}" var="mBBSImg" varStatus="statusimglist" >
                                    <div class="carousel-item <c:if test="${statusimglist.count== 1 }">active</c:if>">
                                       <img class="d-block w-100" src="<c:url value="/images/bbs/bbsno${thisMeetingBBSList['BBSNO'] }/${mBBSImg}"/>" style="max-width: 100%; height: 500px;">
                                    </div>
                              </c:forEach>
                           </div>
                           <c:if test="${thisMeetingBBSList['imgcount'] != '1' }">
                        ...
                        <!-- 좋아요/댓글수 -->
                           <c:if test="${thisMeetingBBSList['userLike'] ==1}" var="notLike">
                               <img alt="image" id="likeImg${status.count }"
                             style="height: 30px; width: 30px; margin-top: 0px; margin-bottom: 10px; margin-right: 10px;"
                              src="resources/images/heartOn.png"  
                         onclick="javascript:liketoggle('likeImg${status.count }', '${thisMeetingBBSList['BBSNO']}')"> 
                          </c:if>
                           <c:if test="${not notLike}">
                          <img alt="image" id="likeImg${status.count }"
                             style="height: 30px; width: 30px; margin-top: 50px; margin-bottom: 10px; margin-right: 10px;"
                        ...
                        <div class="text" style="margin-top: 10px;">
                           <div class="d-flex align-items-center">
                              <div class="position" style="width: 710px;">
                                 ${thisMeetingBBSList['CONTENTS'] }</div>
                           </div>
                        </div>

                        <!-- 작성 날짜 -->
                        <div class="col-md-12"
                           style="padding-left: 0px; padding-right: 0px; text-align: right; padding-top: 10px; color: gray;"><fmt:formatDate var="resultRegDt" value="${thisMeetingBBSList['BBSPOSTDATE'] }" pattern="yyyy-MM-dd"/>${resultRegDt}</div>
                        ...
                        <div class="text" style="margin-top: 20px;">
                           <div class="commentinput" style="align-items: center">
                              ...
                              <c:if test="${oneMember.profileimg == null}" var="notNull">
                                 <div class="icon d-flex align-items-center" style="width: 50px; height: 50px; margin-right: 10px;"></div>
                              </c:if>
                              <c:if test="${not notNull}">
                                 <img class="icon d-flex align-items-center" style="width: 50px; height: 50px; border-radius: 50%; background-color:#FFB8A8;"  src="<c:url value="/images/${oneMember.id}/${oneMember.profileimg}"/>"></img>
                              </c:if>
                        ...
                        <!-- 댓글 부분 -->
                        <div class="commentall" id="commentall${thisMeetingBBSList['BBSNO'] }"
...
//          bbsno= $("#bbsno").val();
            ...
            if(element["profileimg"]==null){
               ...
               comments+="<img class=icon d-flex align-items-center' style='width: 50px; height: 50px; border-radius: 50%; background-color:#FFB8A8;'  src='<c:url value='/images/"+element["profileimg"]+"'/>'></img>"
             }
           comments+="<div class='comments col-md-8 col-md-offset-1' style='margin-left: 0px; width: 450px; height: 32px; '>"+element["commentContents"]+"</div>";
