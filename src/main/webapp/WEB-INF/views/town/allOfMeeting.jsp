                              ...
                              if (data[0].no == "no") {
                                 ...
                                 for (var i = 0; i < data.length; i++) {
                                    ...
                                    if (data[i].bannerImg == null) {
                                       ...
                                       div += "<img src='<c:url value='/images/"+data[i].operator+"/"+data[i].meetingName+"/"+data[i].bannerImg+"'/>' alt='Raised circle image' style='width: 200px; height: 200px; margin-left: 7%; margin-top:5%'>";
                                    }
               ...
               .ajax({
                  ...
                  success : function(data) {
                     ...
                     for (var i = 0; i < data.length; i++) {
                        ...
                        section += "<div class='img img-5 d-flex d-flex justify-content-end' style='background-image: url(/app/images/"
                              + data[i].operator
                              + "/"
                              + data[i].meetingName
                              + "/"
