...
public class MeetingViewController {
   ...
   //==============================모임 상세 TOP=========================================
	...
	public String MeetingViewBBS(@RequestParam Map map,Model model,Authentication auth) {
		...
		List<Map> thisMeetingBBSList = bbs.meetingViewBBS(map);
		for(Map bbsMap:thisMeetingBBSList) {
			...
			List mBBSImg = bbs.mBBSImg(bbsno);
		...
		model.addAttribute("thisMeetingBBSList", thisMeetingBBSList);
		System.out.println(thisMeetingBBSList);
	...
	public String noticeDeleteProcess(@RequestParam Map map) {
		...
		return "forward:/town/allOfMeeting.do";
	}
	//================================================================
