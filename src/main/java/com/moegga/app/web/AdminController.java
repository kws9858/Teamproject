...
public class AdminController {
	...
	public String bbsAccusation(@RequestParam Map map, Model model, HttpServletRequest req) {
		...
		String pagingString = Paging.pagingAccusation(totalRecord, pageSize, blockPage, nowPage,
				req.getContextPath() + "/Admin/Accusation/BBS.do?");
	...
	public String meetingAccusation(@RequestParam Map map, Model model, HttpServletRequest req) {
		...
		String pagingString = Paging.pagingAccusation(totalRecord, pageSize, blockPage, nowPage,
				req.getContextPath() + "/Admin/Accusation/Meeting.do?");
		model.addAttribute("list", list);
		model.addAttribute("pagingString", pagingString);
		model.addAttribute("totalRecord", totalRecord);
		model.addAttribute("nowPage", nowPage);
	...
	public String noticeList(@RequestParam Map map, Model model, HttpServletRequest req) {
		...
		String pagingString = Paging.pagingAccusation(totalRecord, pageSize, blockPage, nowPage,
				req.getContextPath() + "/Admin/Notice/List.do?");
		model.addAttribute("list", list);
		model.addAttribute("pagingString", pagingString);
		model.addAttribute("totalRecord", totalRecord);
		model.addAttribute("nowPage", nowPage);
	...
	public String uploadSummernoteImageFile(@RequestParam("file") MultipartFile multipartFile,
		...
		try {
			...
			jsonObject.addProperty("url", "/app/resources/fileupload/" + savedFileName); // contextroot + resources +
																							// 저장할 내부 폴더명
